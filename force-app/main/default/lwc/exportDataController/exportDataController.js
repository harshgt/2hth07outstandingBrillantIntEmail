...
import getAccountDataToExport from '@salesforce/apex/ExportDataControllerClass.getAccountDataToExport';

export default class ExportDataController extends LightningElement {
    @track conatctData = {}
